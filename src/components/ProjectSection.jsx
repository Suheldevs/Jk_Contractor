          ...
          <div className="w-full h-full p-4 md:p-10 overflow-y-auto">
            <div className="max-w-6xl mx-auto bg-white rounded-xl overflow-hidden shadow-2xl">
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-6 ">
                  <div className="inline-flex items-center px-3 py-1 rounded-full bg-red-50 text-red-600 font-medium text-sm mb-2">
                    {selectedProject.category}
                  </div>

                  <h2 className="text-2xl play md:text-3xl font-bold text-gray-900 mb-2">
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg mb-6">
                    ...
                    <p className="text-gray-600">
                      ...
                      <br />
                      {/* JK Contractor successfully completed this project with a
                      focus on quality, efficiency, and sustainability. The
                      project was delivered on time and within budget, meeting
                      all client specifications and exceeding expectations. */}
                    </p>
