    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-red-500 mb-2">COMPANY NAME</h2>
              <div className="w-16 h-1 bg-red-500 mb-4"></div>
              <p className="text-gray-300 mb-4">
                Providing exceptional infrastructure and environmental services since 2005. We're committed to excellence and sustainability in all our operations.
              </p>
            </div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index} className="flex items-center group">
                  ...
                  <a href="#" className="text-gray-300 hover:text-red-400 transition-colors duration-300">{service}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index} className="flex items-center group">
                  <ArrowRight size={16} className="text-red-500 mr-2 transition-transform duration-300 group-hover:translate-x-1" />
                  <a href="#" className="text-gray-300 hover:text-red-400 transition-colors duration-300">{link}</a>
                </li>
              ))}
            </ul>
          </div>
            ...
            <ul className="space-y-4">
              <li className="flex">
                ...
                <span className="text-gray-300">
                  123 Infrastructure Road, New Delhi, 110001, India
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@company.com" className="text-gray-300 hover:text-red-400 transition-colors duration-300">
                  info@company.com
                </a>
              </li>
            </ul>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <ul className="flex space-x-4 text-sm text-gray-400">
                <li><a href="#" className="hover:text-red-400 transition-colors duration-300">Terms</a></li>
                <li><a href="#" className="hover:text-red-400 transition-colors duration-300">Privacy</a></li>
                <li><a href="#" className="hover:text-red-400 transition-colors duration-300">Cookies</a></li>
              </ul>
            </div>
          </div>
        </div>
