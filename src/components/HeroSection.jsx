    ...
    <div className="relative w-full lg:h-screen h-[95vh] overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-green-400 rounded-full animate-ping delay-1000"></div>
          <div className="absolute top-1/3 right-1/3 w-1 h-1 bg-white rounded-full animate-pulse delay-2000"></div>
          <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-green-300 rounded-full animate-ping delay-3000"></div>
        </div>
      </div>
      ...
      <div className="relative mt-8 lg:mt-14 h-full flex flex-col items-center justify-center text-white px-4 sm:px-6 lg:px-8">
        <div className={`max-w-5xl mx-auto text-center transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <div className="inline-flex border border-white/30 justify-center items-center gap-3 mb-4 bg-black/20 backdrop-blur-md p-3 px-6 rounded-full md:text-lg  hover:bg-black/30 transition-all duration-300 group">
            <div className="bg-green-600 h-2.5 w-2.5 rounded-full animate-pulse"></div> 
            <span className="bg-gradient-to-r from-white to-green-100 bg-clip-text text-transparent font-medium">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight ">
            ...
            <span className="block text-green-500 relative h-20 overflow-hidden">
              <span 
                key={currentText}
          ...
          <div className="mt-12 flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
            <a
            href='#service' 
              className="group relative px-10 py-3 bg-gradient-to-r from-green-600 to-green-700 rounded-xl overflow-hidden text-white font-semibold transition-all duration-500 hover:from-green-700 hover:to-green-800 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/25 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-black transform-gpu"
            >
              {/* Shine effect */}
      ...
      <div className="absolute bottom-8 right-8 hidden lg:flex flex-col space-y-4">
        {[
          ...
          >
            ...
            <div className="w-full h-0.5 bg-gradient-to-r from-green-500 to-transparent mt-2 rounded-full"></div>
          </div>
        ))}
      </div>
